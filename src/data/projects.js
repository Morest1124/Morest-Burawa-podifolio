export const ALL_PROJECTS = [
  {
    ...
    media: [
      { type: "video", src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", poster: "https://picsum.photos/seed/1a/1200/800" },
    ...
    caseStudy: "This project focused on increasing conversion by simplifying the hero and adding subtle motion. Performance budgets were kept tight and images were lazy-loaded.",
  ...
  },
  {
    ...
    caseStudy: "Built a small component library to speed up development across products. Emphasis on accessibility and visual regression tests.",
  ...
  },
  {
    ...
    media: [
      ...
      { type: "video", src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", poster: "https://picsum.photos/seed/3b/1200/800" },
    ],
    frontendLive: null,
    backendLive: "https://api.example.com",
    designUseCase: "N/A",
    caseStudy: "Designed a REST API with JWT auth, product catalog endpoints, and webhooks for payments. Documentation was delivered via OpenAPI.",
  ...
  },
  {
    ...
    media: [
      ...
      { type: "video", src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", poster: "https://picsum.photos/seed/4c/1200/800" },
    ],
    frontendLive: null,
    backendLive: "https://chat.example.com",
    designUseCase: "N/A",
    caseStudy: "Implemented socket-based presence and message delivery guarantees. Scalability using Redis pub/sub and horizontal workers.",
  ...
  },
  {
    ...
    media: [
      { type: "video", src: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", poster: "https://picsum.photos/seed/5a/1200/800" },
    ...
    caseStudy: "Developed a cohesive identity system with scalable logo variants and a color system optimized for accessibility.",
  ...
  },
  {
    ...
    frontendLive: null,
    backendLive: null,
    designUseCase: "Templates for paid ads and social channels, sized for mobile-first consumption.",
    caseStudy: "Created a set of templates that reduced asset production time by 60%.",
  ...
  // extras
  {
    ...
    backendLive: null,
    designUseCase: "N/A",
    caseStudy: "Tree-shaken bundles and code-splitting led to a 40% faster Largest Contentful Paint.",
  ...
  },
  {
    ...
    backendLive: null,
    designUseCase: "N/A",
    caseStudy: "Performed automated and manual testing, fixed focus order, and improved contrast ratios.",
    tech: ["axe", "Cypress"],
    year: 2024,
  },
  {
    ...
    designUseCase: "N/A",
    caseStudy: "Separated services and introduced service discovery, CI pipelines and contract tests.",
  ...
  },
  {
    ...
    designUseCase: "N/A",
    caseStudy: "Built a scalable index with incremental updates and relevance tuning.",
  ...
  },
  {
    ...
    frontendLive: null,
    backendLive: null,
    designUseCase: "Illustrations were used in onboarding to explain features visually.",
    caseStudy: "Delivered a pack of 20 SVG illustrations with multiple color variants.",
